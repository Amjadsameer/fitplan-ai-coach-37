...
const translations = {
  en: {
    ...
    aiSwap: "AI swap",
    availableIngredients: "Available ingredients (optional)",
    ingredientsPlaceholder: "e.g. chicken breast, rice, broccoli...",
    generate: "Generate with AI",
    generating: "Generating...",
    targetCalories: "Target calories",
    aiError: "Could not generate recipe. Try again.",
    rateLimited: "Too many requests. Please wait a moment.",
    creditsExhausted: "AI credits exhausted. Please add credits.",
    close: "Close",
  ...
  ar: {
    ...
    activityActive: "نشط",
    veryActive: "نشط جداً",
    estimatedTdee: "إجمالي السعرات اليومية",
    dailyTargetKcal: "الهدف اليومي",
    save: "حفظ",
    cancel: "إلغاء",
    ...
    alternatives: "بدائل",
    aiSwap: "تبديل بالذكاء",
    availableIngredients: "المكونات المتوفرة (اختياري)",
    ingredientsPlaceholder: "مثال: صدر دجاج، أرز، بروكلي...",
    generate: "توليد بالذكاء الاصطناعي",
    generating: "جاري التوليد...",
    targetCalories: "السعرات المستهدفة",
    aiError: "تعذّر توليد الوصفة. حاول مرة أخرى.",
    rateLimited: "طلبات كثيرة. انتظر لحظة من فضلك.",
    creditsExhausted: "نفدت رصيد الذكاء. الرجاء إضافة رصيد.",
    close: "إغلاق",
    ...
    generatePlan: "توليد خطة الأسبوع",
    ...
    promoteAdmin: "ترقية لمدير",
    demoteAdmin: "إزالة المدير",
    activeProvider: "مزوّد الذكاء الفعّال",
    useDefault: "استخدام الافتراضي",
    addKey: "إضافة مفتاح",
    active: "فعّال",
    activate: "تفعيل",
    activateNow: "تفعيله الآن",
    meals: {
